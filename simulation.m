...
function [averageThroughput, jainsFairnessIndex] = simulationRun(UEnum, schedulerType)
	...
	% Connect the UE nodes to the gNB node with Full Buffer Traffic
	connectUE(gNB,UEs,FullBufferTraffic="DL")
    
    %{
    % Connect the UE nodes to the gNB node with FTP Traffic
    connectUE(gNB, UEs);
...
legend({'Round Robin', 'Proportional Fair','Packet Loss Ratio', ...
